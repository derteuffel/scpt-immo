...
import com.derteuffel.scpt.helpers.requests.LoginRequest;
import com.derteuffel.scpt.helpers.requests.RegisterRequest;
import com.derteuffel.scpt.helpers.responses.JwtResponse;
...
import com.derteuffel.scpt.securities.jwts.JwtUtils;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "root":
                        Role modRole = roleRepository.findByName(ERole.ROLE_ROOT)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
